...
#ifndef SERRA_KERNEL_COMMON_H
#define SERRA_KERNEL_COMMON_H

  // -------------- commonInformationTable and associated types --------------
...
*/
  ...
  */
  ...
  // ---------------- entrypointReturnValue and related types ----------------
  ...
  */
  ...
  /* const char** EntrypointStatusCodes[n]
  ...
  */
  ...
  const char** EntrypointStatusCodes[8] = {
