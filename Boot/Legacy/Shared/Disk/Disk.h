...
#define SERRA_SHARED_DISK_H
  ...
  typedef struct _eddDriveParameters {
  ...
  typedef volatile struct _eddDiskAddressPacket {
  ...
  typedef struct _biosParameterBlock_Fat16 {
  ...
  typedef struct _biosParameterBlock_Fat32 {
